...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_BLUE_Pin|LED_ORANGE_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PCPin PCPin PC10 PC11 */
  GPIO_InitStruct.Pin = LED_BLUE_Pin|LED_ORANGE_Pin|GPIO_PIN_10|GPIO_PIN_11;
